...
@Component({
  selector: 'app-gamewcs',
  templateUrl: './gamewcs.component.html',
  styleUrls: ['./gamewcs.component.scss'],
})
export class GamewcsComponent implements OnInit {
  closeResult: string;
