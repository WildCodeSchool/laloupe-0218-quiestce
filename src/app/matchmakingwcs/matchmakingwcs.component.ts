...
@Component({
  selector: 'app-matchmakingwcs',
  templateUrl: './matchmakingwcs.component.html',
  styleUrls: ['./matchmakingwcs.component.scss'],
})
export class MatchmakingwcsComponent implements OnInit {
